...
{    qDebug("initResources");
	...
	// Shaders
	VkShaderModule vertShaderModule = createShader(QStringLiteral("color.vert.spv"));
	VkShaderModule fragShaderModule = createShader(QStringLiteral("color.frag.spv"));
...
void VulkanRenderer::startNextFrame()
{
	...
	m_devFuncs->vkCmdBindVertexBuffers(cmdBuf, 0, 1, &m_buf, &vbOffset);
